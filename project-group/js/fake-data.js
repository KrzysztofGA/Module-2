model.users = [
    { name: 'Mr. Blue', color: 'blue' },
    { name: 'Mr. Green', color: 'green' },
    { name: 'Ms. Red', color: 'red' },
];

model.groups = [
    { name: 'Blue about blue 1', color: 'blue' },
    { name: 'Blue about green 1', color: 'blue' },
    { name: 'Blue about red 1', color: 'blue' },
    { name: 'Blue about blue 2', color: 'blue' },
    { name: 'Blue about green 2', color: 'blue' },
    { name: 'Blue about red 2', color: 'blue' },
    { name: 'Green about green 1', color: 'green' },
    { name: 'Green about blue 1', color: 'green' },
    { name: 'Green about red 1', color: 'green' },
    { name: 'Green about green 2', color: 'green' },
    { name: 'Green about blue 2', color: 'green' },
    { name: 'Green about red 2', color: 'green' },
    { name: 'Red about red 1', color: 'red' },
    { name: 'Red about blue 1', color: 'red' },
    { name: 'Red about green 1', color: 'red' },
    { name: 'Red about red 2', color: 'red' },
    { name: 'Red about blue 2', color: 'red' },
    { name: 'Red about green 2', color: 'red' },
];
